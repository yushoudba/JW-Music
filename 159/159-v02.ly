...
%% 159 榮耀歸給耶和華 — 主旋律 + 左手伴奏（大譜表）v02
%% 旋律依 音樂/source/sjjsm_CH.pdf pp.240–241（來源/v01-pageN.png）
%% 音高校正：Finale Opus 符頭 bbox 中心偏高約 2 音級；改以 origin／肉眼符頭為準
%% （與 156-v02 相同校正：center 讀 G → 實際 E）。Capo 5 上排忽略。
%% 左手：4/4 低音＋柱式（個人練習編配）
...
\header {
  title = "榮耀歸給耶和華"
  subtitle = "主旋律 + 左手伴奏"
  subsubtitle = "詩歌 159 · 詩篇 96:8 · F 大調 · 4/4 · v02"
...
melody = {
  ...
  \mark \markup \box "主歌"
  %% 至高的上帝耶 | 和華，
  f'4 e'8 c'8 f'4 e'8 c'8 |
  c'4 d'8 d'8 r2 |
  \break

  %% 你多麼尊貴、偉 | 大。
  g'4 f'8 d'8 g'4 f'8 d'8 |
  e'2 r2 |
  \break

  %% 抬頭望天我能 | 看見，你
  a'4 g'8 e'8 a'4 g'8 e'8 |
  e'4 f'8 f'8 r4 r8 e'8 |
  \break

  %% 充滿力量和榮 | 美。
  d'4 c'8 bes8 d'4 c'8 bes8 |
  c'2 r2 |
  \break
  ...
  %% 時刻受到天父 | 恩待，該
  a'4 g'8 e'8 a'4 g'8 e'8 |
  e'4 f'8 f'8 r4 r8 g'8 |
  \break

  %% 怎樣報答你的愛？ | 我要歌
  a'4 a'8 bes'8 g'4 f'8 e'8 |
  r2 r8 f'8 f'8 a'8 |
  \break

  \mark \markup \box "副歌"
  %% 頌偉大的耶和 | 華，將你
  f'4 f'8 c''8 c''4 bes'8 a'8 |
  g'4 a'4 r2 |
  \break
...
\markup \column {
  \line \bold { "彈奏說明" }
  \vspace #0.2
  \line { "• 右手：主旋律（依 sjjsm_CH.pdf；v02 已校正 Opus 符頭偏移）" }
  \line { "• 左手：4/4「低音＋柱式和弦」" }
  \line { "• Capo 5 上排忽略；譜面為 concert F" }
  \line { "• v02：修正 v01 主旋律整體偏高約兩個音級的錯誤" }
}
